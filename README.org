...
* Install iimatey
Matey depends on the tools tmux, ttyd, and the [[https://github.com/coder/wgtunnel][coder/wgtunnel]] tunnel client and an runnnig instance of tunneld. These scripts are setup to use the instance of tunneld at https://try.sharing.io which is configured via [[https://github.com/sharingio/infra/tree/uk/apps/tunneld][sharingio/infra]]
